 ...
 */
public class MetaData implements GJNoArguVisitor<String> {
    HashMap<Node, HashMap<String, String>> graph, params;
    Node currNode;

    public MetaData(HashMap<Node, HashMap<String, String>> graph, HashMap<Node, HashMap<String, String>> params) {
        this.graph = graph;
        this.params = params;
    }
    ...
    public String visit(MainClass n) {
        String _ret = null;
        currNode = n;
        graph.put(n, new HashMap<String, String>());
        n.f0.accept(this);
        n.f1.accept(this);
        n.f2.accept(this);
        n.f3.accept(this);
    ...
    public String visit(VarDeclaration n) {
        String _ret = null, type, var;
        type = n.f0.accept(this);
        var = n.f1.accept(this);
        graph.get(currNode).put(var, type);
        n.f2.accept(this);
        return _ret;
    }
    ...
    public String visit(MethodDeclaration n) {
        ...
        currNode = n;
        graph.put(n, new HashMap<String, String>());
        params.put(n, new HashMap<String, String>());
        n.f0.accept(this);
        n.f1.accept(this);
        n.f2.accept(this);
        n.f3.accept(this);
    ...
    public String visit(FormalParameter n) {
        ...
        type = n.f0.accept(this);
        var = n.f1.accept(this);
        params.get(currNode).put(var, type);
        return _ret;
    }
